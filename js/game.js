...
toggleButton.style.fontFamily = "Helvetica, sans-serif";
...
toggleButton.onmouseout = () => {
	toggleButton.style.background = darkMode ? "#333" : "#222";
};
...
toggleButton.addEventListener("click", function () {
    ...
    toggleButton.innerText = darkMode ? "☀️ Light Mode" : "🌙 Dark Mode";
    toggleButton.style.background = darkMode ? "#333" : "#eee";
    toggleButton.style.color = darkMode ? "#fff" : "#000";

    // Adjust hover styles
    toggleButton.onmouseover = () => {
        toggleButton.style.background = darkMode ? "#444" : "#ddd";
    };
    toggleButton.onmouseout = () => {
        toggleButton.style.background = darkMode ? "#333" : "#eee";
    };
...
var render = function () {
    ...
    ctx.fillText("score: " + bird.score.toFixed(1), 12, 32);
};
